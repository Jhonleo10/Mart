    ...
    <LegalDocumentPage
      ...
      sections={[
        ...
        },
        {
          ...
          icon: "userCheck",
          body: `Buyers may register for free to browse software, save wishlists, and request demos. Sellers must complete registration, select a published seller plan, and pay applicable fees before listing products. You are responsible for keeping your login credentials secure and for all activity under your account.`,
        },
        {
          id: "marketplace",
          title: "3. Marketplace Use",
          icon: "scale",
          body: `The Platform connects software buyers with verified vendors. We do not guarantee the accuracy of third-party product listings, pricing, or availability. Demo requests and communications between buyers and sellers are facilitated through the Platform but contractual relationships for software purchases remain between the parties involved.`,
        },
        {
          id: "sellers",
          title: "4. Seller Obligations",
          icon: "store",
          body: `Sellers must provide accurate company and product information, honour demo requests in good faith, and comply with applicable laws. We reserve the right to review, approve, suspend, or remove listings that violate our policies or mislead users. Seller subscription and registration fees are non-refundable except where required by law.`,
        },
        {
          id: "payments",
          title: "5. Payments",
          icon: "badgeIndianRupee",
          body: `Seller registration and subscription payments are processed securely through our payment partners (e.g. Razorpay). Fees correspond to the plan selected at checkout and as configured in our admin settings. Failed or disputed payments may result in account suspension until resolved.`,
        },
        {
          id: "conduct",
